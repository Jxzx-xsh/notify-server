...
import dayjs, { getDaysToBirthday } from '../../../utils/dayjs'
...
export const textCardTemplate = (data: TextCardTemplateProps) => {
  ...
  // 距离生日天数
  const birthday = getDaysToBirthday(7, 20)
  // 今日、恋爱天数
...
农历 | ${lubarmonth}${lunarday} ${lunar_festival_info} ${jieqi_info}`
  ...
  if (birthday === 365 || birthday === 366)
    description += '\n今天是我的宝的生日,记得拆给你准备的礼物哦🥳🥳🥳'
  else description += `\n🥳🥳🥳距离我的宝过生日还剩 ${birthday} 天🎉🎉🎉`
